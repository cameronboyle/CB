	...
	<div class="wpv-setting-container wpv-setting-container-horizontal wpv-settings-layout-markup js-wpv-settings-layout-extra<?php echo $hide; ?>">
		...
		<div class="wpv-setting" data>
			...
			<p class="js-wpv-layout-css-editor-old-place">
				...
				<button class="button-secondary js-code-editor-button layout-css-editor-button" data-target="layout-css-editor" data-state="closed" data-closed="<?php echo htmlentities( __( 'Open CSS editor', 'wpv-views' ), ENT_QUOTES ); ?>" data-opened="<?php echo htmlentities( __( 'Close CSS editor', 'wpv-views' ), ENT_QUOTES ); ?>">
			...
			<div class="js-code-editor code-editor layout-css-editor closed" data-name="layout-css-editor">
				...
				<textarea cols="30" rows="10" id="wpv_layout_meta_html_css" name="_wpv_settings[layout_meta_html_css]"><?php echo ( isset( $view_settings['layout_meta_html_css'] ) ) ? $view_settings['layout_meta_html_css'] : ''; ?></textarea>
			</div>
			...
			<p class="js-wpv-layout-js-editor-old-place">
				...
				<button class="button-secondary js-code-editor-button layout-js-code-editor-button" data-target="layout-js-editor" data-state="closed" data-closed="<?php echo htmlentities( __( 'Open JS editor', 'wpv-views' ), ENT_QUOTES ); ?>" data-opened="<?php echo htmlentities( __( 'Close JS editor', 'wpv-views' ), ENT_QUOTES ); ?>">
			...
			<div class="js-code-editor code-editor layout-js-editor closed" data-name="layout-js-editor">
				...
				<textarea cols="30" rows="10" id="wpv_layout_meta_html_js" name="_wpv_settings[layout_meta_html_js]"><?php echo ( isset( $view_settings['layout_meta_html_js'] ) ) ? $view_settings['layout_meta_html_js'] : ''; ?></textarea>
			</div>
